...
if(isset($_POST['post_property']))
{
    ...
    // $query=mysqli_query($con,"insert into tblimages(Image) values('$imgnewfile1')");
        $postData = "INSERT INTO `tbl_houses`(`pname`, `pimg1`, `pimg2`, `pimg3`, `pimg4`, `pimg5`, `furnish_status`, `BHK`, `description`, `ptype`, `price`, `availabilty`, `Sqft`, `btype`, `plocation`, `country`, `state`, `city`, `floorno`, `pAge`, `totalroom`, `Bedrooms`, `LivingRoom`, `Kitchen`, `Bathroom`, `cameras`, `wifi`, `gym`, `pool`, `elevator`, `airconditioner`, `balcony`, `parks`, `clubhouse`, `dogpark`, `garage`) VALUES ('$p_name','$imgnewfile1','$imgnewfile2','$imgnewfile3','$imgnewfile4','$imgnewfile5','$furnished_status','$bhk','$p_description','$p_type','$p_price','$isFeatured','$p_carpet','$offer_type','$p_address','$p_country','$p_state','$p_city','$p_floor','$p_age','$p_room','$p_bedroom','$p_living','$p_kitchen','$p_bathroom','$camera','$wifi','$gym','$pool','$elevator','$airconditioner','$balcony','$parks','$clubhouse','$dogpark','$garage')";
        $add_property = mysqli_query($conn, $postData);
    
    if($add_property==true)
    {
    $msg="<p class='alert alert-success'>Your Property has been posted.</p>";
	header("Location:view_property.php?msg=$msg");
    }
    else
    {
        $msg="<p class='alert alert-warning'>Your Property has not been posted.</p>";
        header("Location:view_property.php?msg=$msg");
    }
    }
    mysqli_close($conn);
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p></p>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active">Dashboard / Add Property</li>
                        </ul>
                    </div>
                </div>
            </div>
