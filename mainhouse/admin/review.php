    ...
    <?php include 'includes/header.php'; ?>
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p></p>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item active">Dashboard / Review</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        {		
            ...
            <tr>
                ...
                <td><?php echo $result['user_rating']; ?></td>
                <td><?php echo $result['user_review']; ?></td>
                <td><?php echo $result['mail']; ?></td>
                <td><?php echo $result['datetime']; ?></td>
                <td><a href="contactdelete.php?id=<?php echo $result['review_id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
            </tr>
            <?php
             $cnt=$cnt+1;
        }
